# Terminal Velocity
Bullets fly, flying faster, and faster you must become too.
**Terminal Velocity** is a fast-paced terminal bullet-dodging game written in Python.
...
- python main.py
- python3 main.py
- terminal-velocity **(Only for pip install -e)**
